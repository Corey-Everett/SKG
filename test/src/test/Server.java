...
public class Server {  
    ...
    public static void main(String[] args) throws IOException { 
    	...
    	File file = new File("C:\\Users\\marinom1\\eclipse-workspace\\test\\src\\reviewedGames");
    ...
    public void run() { 
        ...
        while (true) {   
            ...
            try { 
    			...
    			//		PrintWriter writer = new PrintWriter(new FileWriter("reviewedGames"), true);
    					File file = new File("C:\\Users\\marinom1\\eclipse-workspace\\test\\src\\reviewedGames");
    					FileWriter writer = new FileWriter(file, true); //the true here makes it so the writer will not overwrite old data
    			...
    			//		dos.writeUTF("debugGameNameVariablePrint: " + gameName + ". debugReviewVariablePrint: " + review);
    				...
    				//	File file = new File("C:\\Users\\marinom1\\eclipse-workspace\\test\\src\\reviews.txt");
    				//	FileWriter writer1 = new FileWriter("reviews.txt", true); //the true here makes it so the writer will not overwrite old data    				    					
    			    //	writer1.write(gameName + review);  			    	//writes the game name and review to the file
    			    //	writer1.close();
